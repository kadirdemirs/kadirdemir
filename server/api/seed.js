...
<p><a href="/iletisim">Contact us</a> to build your TikTok strategy with our professional team.</p>`,
  ...
  },
  {
    ...
    titleEn: 'Reaching the First 1000 Subscribers on YouTube: What I Know After 14 Years',
    excerptTr: 'İlk 1000 abone en zor olanı. Geriye dönüp baktığımda işe yarayan birkaç şey vardı.',
    excerptEn: 'The first 1000 subscribers are the hardest. Looking back, a few things actually worked.',
    contentTr: `İlk videomu yüklediğimden bu yana 14 yıl geçti. İlk 1000 aboneye ulaşmak diğer 100.000\'den daha zordu.\n\n**Sabır değil tutarlılık**\nİnsanlar "sabırlı ol" der ama mesele sabır değil, tutarlılık. Haftada bir video yüklüyorsan, 14 hafta üst üste yükle. Algoritma değil, izleyici alışkanlıklarına oynuyor.\n\n**Niş bul, sonra genişlet**\nİlk başlarda her şeyi denedim. İşe yarayan: tek bir konuda derinleşmek. Sonra orada zemin tutunca yan konulara açılmak.\n\n**Thumbnail ve başlık videodan önemli**\nVideoyu kimse açmazsa içerik ne kadar iyi olduğunun önemi yok. İlk 1000 abonede en çok bu öğrenildi.\n\n**Yorumlara cevap ver**\nİlk yıllarda her yoruma cevap verdim. O insanların yarısı hâlâ takipte.`,
    contentEn: `It's been 14 years since I uploaded my first video. Reaching the first 1000 subscribers was harder than the next 100,000.\n\n**Not patience, consistency**\nPeople say "be patient" but it's not about patience, it's about consistency. If you upload weekly, upload for 14 weeks straight. You're playing to viewer habits, not the algorithm.\n\n**Find a niche, then expand**\nEarly on I tried everything. What worked: going deep on one topic. Then once you have a foothold, expanding sideways.\n\n**Thumbnail and title matter more than the video**\nIf nobody clicks, content quality doesn't matter. Biggest lesson from the first 1000 subs.\n\n**Reply to comments**\nIn the early years I replied to every comment. Half of those people still watch.`,
  ...
  },
  {
    ...
    contentTr: `Bir videoyu 8 saat kurgulayıp 14 dakika tutmak garip bir his. Ama o 14 dakika için 8 saat değer mi? Genelde evet.\n\n**Kes, kes, kes**\nİlk taslakta hep uzun olur. Soğuk kafayla geri dönüp her sahnenin "burada ne kadar tutmalı?" sorusunu sor. Cevap genelde "daha az."\n\n**Müzik son adım**\nMüziği baştan koyarsan kurgunun ritmini ona kaptırırsın. Önce görüntü, sonra ses tasarımı, en son müzik.\n\n**Jump cut iyi bir araç değildir**\nEn azından her yerde değil. İzleyici nefes alacak boşluk ister. Sürekli kesmek panik yapar.\n\n**Sonu önce yaz**\nVideonun nereye varacağını bilmiyorsan kurgu rastgele olur. Son cümle netse, geri kalan kendini bulur.`,
    contentEn: `Spending 8 hours to edit a 14-minute video is a strange feeling. Is it worth it? Usually yes.\n\n**Cut, cut, cut**\nFirst drafts are always too long. Come back with fresh eyes and ask every scene "how long should this hold?" The answer is usually "less."\n\n**Music is the last step**\nIf you start with music you'll lose the edit rhythm to it. Picture first, then sound design, then music.\n\n**Jump cuts aren't great**\nNot everywhere at least. Viewers need room to breathe. Constant cuts feel panicked.\n\n**Write the ending first**\nIf you don't know where the video lands, the edit will be random. Once the final line is clear, the rest falls in place.`,
    category: 'Süreç', categoryEn: 'Process',
